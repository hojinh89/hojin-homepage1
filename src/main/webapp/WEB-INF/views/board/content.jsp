                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="<c:url value='/user/file/${article.writer}'/>" alt="user image" onerror="this.src='/resources/profile1.jpg'">
                            <span class="username">
...
<script id="replyTemplate" type="text/x-handlebars-template">
    ...
    <div class="post replyDiv" data-replyNo={{replyNo}} style = "margin-left: <c:out value='{{replyMarginTest depth}}'/>;">
        <div class="user-block">
			...
			<img class="img-circle img-bordered-sm" src="<c:url value='/user/file/{{replyWriter}}'/>" alt="user image" onerror="this.src='/resources/profile1.jpg'">
