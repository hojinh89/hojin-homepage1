          ...
          <c:if test="${not empty login}">
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="height:50px; padding:3px; margin-right : 15px;">  
                        	<span><img src="<c:url value='/user/file/${login.userId}'/>" alt="" onerror="this.src='/resources/profile2.jpg'" style="width:44px; height:44px;"></span>
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-header" style = "background-color : white; padding: 0px;">                                
                                ...
                                ${login.userName} 님</p>
                                <span><img src="<c:url value='/user/file/${login.userId}'/>" alt="" onerror="this.src='/resources/profile2.jpg'" style="width:150px; height:140px;"></span>
                            </li>
                            
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<c:url value='/user/profile'/>" class="btn btn-default btn-flat"><i
