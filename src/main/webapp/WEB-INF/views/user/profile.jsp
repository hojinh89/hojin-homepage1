...
<div class="register-box">
    ...
    <div class="register-box-body">
          ...
          <form role="form" id="profileForm" method="post" action="<c:url value='/user/profile' />" enctype="multipart/form-data">
						...
						<tr>
							<td>
							 	...
							 	style = "background-color: #ff52a0; margin-top: 0; height: 40px; color: white; border: 0px solid #f78f24; opacity: 0.8">업로드</button> 
							  	...
							  	<img id="preImg" src="<c:url value='/user/file/${login.userId }'/>" onerror="this.src='/resources/profile1.jpg'" style="margin-top : 5px; width : 320px; height : 300px;"/>							
							</td>
						</tr>
